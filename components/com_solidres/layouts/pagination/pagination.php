...
function pagination_list_render($list)
{
	...
	$html .= '<ul class="pagination-list pagination ms-0 mb-4">';
...
function pagination_item_active(&$item)
{
	...
	return '<li' . $class . '><a data-start="' . $item->base . '" title="' . $item->text . '" href="' . $item->link . '" class="pagenav page-link" aria-label="' . $aria . '">' . $display . '</a></li>';
}
...
function pagination_item_inactive(&$item)
{
	...
	if ($item->text === JText::_('JLIB_HTML_START'))
	{
		return '<li class="disabled page-item"><a class="page-link"><span class="icon-first" aria-hidden="true"></span></a></li>';
	}

	// Check for "Prev" item
	if ($item->text === JText::_('JPREV'))
	{
		return '<li class="disabled page-item"><a class="page-link"><span class="icon-previous" aria-hidden="true"></span></a></li>';
	}

	// Check for "Next" item
	if ($item->text === JText::_('JNEXT'))
	{
		return '<li class="disabled page-item"><a class="page-link"><span class="icon-next" aria-hidden="true"></span></a></li>';
	}

	// Check for "End" item
	if ($item->text === JText::_('JLIB_HTML_END'))
	{
		return '<li class="disabled page-item"><a class="page-link"><span class="icon-last" aria-hidden="true"></span></a></li>';
	}
...

	{
		...
		return '<li class="active hidden-phone page-item"><a class="page-link" aria-current="true" aria-label="' . $aria . '">' . $item->text . '</a></li>';
	}
