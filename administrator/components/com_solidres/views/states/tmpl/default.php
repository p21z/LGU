                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th class="title" width="40%">
							<?php echo HTMLHelper::_('searchtools.sort', 'SR_HEADING_STATE_NAME', 'name', $listDirn, $listOrder); ?>
                        </th>
                        <th class="center">
							<?php echo HTMLHelper::_('searchtools.sort', 'SR_HEADING_PUBLISHED', 'state', $listDirn, $listOrder); ?>
                        </th>
