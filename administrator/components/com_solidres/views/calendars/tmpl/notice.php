    ...
    <div class="<?php echo SR_UI_GRID_CONTAINER ?>">
        ...
        <div id="sr_panel_right" class="sr_list_view <?php echo SR_UI_GRID_COL_10 ?>">
            <div class="alert alert-info">
                This feature shows availability calendar for your property. You can overview the availability, make quick reservation and block reservation by dragging & dropping directly in the calendar.
            </div>
